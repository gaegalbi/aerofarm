...
public class CommentDto {
    ...
    @QueryProjection
    public CommentDto(Long id, String writer, String content, LocalDateTime localDateTime, Post post, Long writerId, boolean deleteTnF, int groupId, String picture, Long parentId) {
        this.id = id;
        this.writer = writer;
    ...
    @QueryProjection
    public CommentDto(Long id, String writer, String content, LocalDateTime localDateTime, Post post, Long writerId, boolean deleteTnF, int groupId, String picture, Long parentId, String parentNickname) {
        this.id = id;
        this.writer = writer;
        this.content = content;
        this.localDateTime = localDateTime;
