...
import 'CustomQuillToolbar.dart';

class CustomQuillFontSizeButton extends StatefulWidget {
  const CustomQuillFontSizeButton({
    required this.items,
  ...
  @override
  _CustomQuillFontSizeButtonState createState() => _CustomQuillFontSizeButtonState();
}

class _CustomQuillFontSizeButtonState extends State<CustomQuillFontSizeButton> {
  ...
  @override
  void didUpdateWidget(covariant CustomQuillFontSizeButton oldWidget) {
  ...
  void _didChangeEditingValue() {
    if (widget.attribute.key != quill.Attribute.size.key) {
      return;
    }
  ...
  void _showMenu() {
    ...
    final position = RelativeRect.fromLTRB(offset.dx,MediaQuery.of(context).size.height*0.548,100,100);
    //445
    //print(offset.dy);
      /*Rect.fromPoints(
